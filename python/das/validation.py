...
class TypeValidator(object):
   def __init__(self, **kwargs):
      ...
      if "default" in kwargs:
         ...
         self.default = (self._validate_default(default) if default is not None else None)
...
class Tuple(TypeValidator):
   ...
   def _make_default(self):
      if self.default is None:
         return tuple([x._make_default() for x in self.types])
      else:
...
class Or(TypeValidator):
   ...
   def _validate_default(self, value):
      try:
         self.type1._validate_default(value)
      except:
         self.type2._validate_default(value)
   ...
   def _make_default(self):
      return self.type1._make_default()
...
class Optional(TypeValidator):
   ...
   def _make_default(self):
      return self.type._make_default()
